...
- My CIDR IP block lists are meant to function as a nice baseline for individuals and very small organizations that run public-facing servers. If you're dealing with a large amount of traffic on a 24/7 basis - especially international traffic - you will likely want to supplement these lists with more aggressive bogon filtering and region-specific data.
