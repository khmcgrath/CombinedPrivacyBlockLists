...
mkdir -p ~/BLT/btdat
cd ~/BLT/btdat
rm -f webattackBTdat.7z bt_webattack.dat bpeersBTdat.7z bt_bpeers.dat combined-final-win.dat
...
rm -f webattackBTdat.7z bt_webattack.dat bpeersBTdat.7z bt_bpeers.dat
echo "~---_---_---~"
ls -lh ~/BLT/btdat
echo "~---_---_---~"
